    ...
    async request(endpoint, options = {}) {
        ...
        try {
            ...
            if (!contentType || !contentType.includes('application/json')) {
                ...
                // Se contém HTML de erro do PHP, extrair a mensagem
                if (text.includes('<br />') || text.includes('Fatal error') || text.includes('Parse error')) {
                    throw new Error('Erro no servidor PHP. Verifique se o PostgreSQL está rodando e se as credenciais estão corretas.');
                }

/*
  # Modelo Relacional - Salgados da Sara (REV 3)
...
CREATE TABLE IF NOT EXISTS cliente (
    ...
    CONSTRAINT fk_endereco FOREIGN KEY (cod_endereco) REFERENCES endereco(id_endereco),
    CONSTRAINT fk_cidade FOREIGN KEY (sigla_cidade) REFERENCES cidade(sigla),
